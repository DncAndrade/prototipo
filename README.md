...
* Estruturação de Funções (`def`)
* Loops de repetição (`for`) com formatação de strings (`ljust`)
* Versionamento de código e boas práticas de indentação

# 🛠️ Tecnologias Utilizadas

* **Python 3** (Lógica e estrutura)
